# Car Financing in Saudi Arabia: Murabaha vs. Conventional Loans

A car is the second-largest purchase most Saudi households make. How you pay for it matters
more than which model you choose.

## Paying cash

If you can pay cash and still keep six months of expenses in reserve, cash is almost always
the cheapest option: you pay the sticker price and nothing more. The trap is buying cash on a
car that drains the emergency fund. A car you own outright with 10,000 SAR left in the bank is
a worse position than a financed car with 60,000 SAR in the bank.

## Murabaha (the standard Islamic auto finance)

In an auto murabaha, the bank buys the car and resells it to you at a disclosed markup, paid
in fixed monthly installments. There is no interest; there is a **profit rate** agreed up
...
- **Tenor:** 12 to 60 months, with 36 and 48 months the most common.
...
**Worked example.** Finance 120,000 SAR at a 5% flat profit rate over 36 months:

    total profit    = 120,000 x 5%  = 6,000 SAR (markup applied once over the term)
    total repayable = 126,000 SAR
    monthly payment = 126,000 / 36  = 3,500 SAR/month
...
## Conventional (riba-based) auto loans

The conventional equivalent charges compounding interest on a declining balance, quoted as an
APR. Because you pay interest only on the balance still outstanding, an APR is not directly
comparable to a flat markup: a 5% one-off flat markup over three years works out to only about
a 3% *effective* APR, so it can genuinely be cheaper than a conventional loan advertised at
5%–6% APR.

    conventional loan, 120,000 SAR at 5.5% APR over 36 months
...
for your income regardless of how attractive the installment looks.
